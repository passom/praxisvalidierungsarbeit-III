...
Beim Ausscheiden oder internen Wechsel erfahrener Beschäftigter besteht das Risiko, dass informelle Abläufe, persönliche Netzwerke, Fehlererfahrungen und bewährte Vorgehensweisen nicht vollständig übergeben werden. Gelashvili-Luik et al. untersuchen in einer systematischen Literaturübersicht die Chancen und Herausforderungen der Integration neuer KI-Technologien in Wissensmanagementsysteme. Neben der technischen Leistungsfähigkeit heben sie unter anderem Datenqualität, organisatorische Einbettung, Qualifikation, Vertrauen und menschliche Kontrolle als Erfolgsbedingungen hervor \cite{gelashvili2025}. Junghans et al. beschreiben einen thematisch besonders nahen Ansatz, bei dem informelle betriebliche Dialoge mit Sprachverarbeitung und Sprachmodellen in strukturiertes, digital nutzbares Organisationswissen überführt werden \cite{junghans2026}. Kernan Freire et al. zeigen anhand kognitiver Assistenzsysteme im Produktionsumfeld, dass Effizienzpotenziale zugleich mit Fragen zu Privatsphäre, Überwachung, Pflegeaufwand und den Grenzen gegenüber menschlicher Wissensweitergabe verbunden sind \cite{kernanfreire2026}.

Im zugrunde liegenden IHK-Praxisprojekt wurde ein KI-Agent entwickelt, der einen festgelegten Interviewleitfaden durchläuft, Rohantworten speichert, Kurzfassungen erzeugt, diese vorgegebenen Kategorien und Keywords zuordnet und DOCX-Ergebnisdateien bereitstellt \cite{sommer2026projekt}. Die Projektdokumentation kalkuliert für einen vollständig manuellen Wissenssicherungsprozess 120 Minuten und für den agentengestützten Ablauf 45 Minuten. Diese Werte beschreiben ein modelliertes Potenzial, beantworten jedoch nicht, ob die erzeugten Dokumente fachlich vollständig, quelltreu und bei wiederholter Ausführung stabil sind.

Die vorliegende Arbeit trennt deshalb zwei Untersuchungsziele. Erstens werden zwei tatsächlich im Praxisprojekt erzeugte Ergebnisdateien desselben Interviewfalls empirisch gegen einen Referenzstandard geprüft. Zweitens wird das entwickelte Bewertungsverfahren mit synthetischen Vollinterviews, gezielt manipulierten Ausgabebeispielen und isolierten Grenzfällen methodisch erprobt. Die synthetischen Daten dienen nicht als Leistungsnachweis des implementierten Agenten. Sie prüfen, ob Codierregeln und Testkriterien typische Fehlerarten eindeutig erfassen können.
...
Der empirische Kern besteht aus einem vollständigen Interviewanwendungsfall zum LMLV-Toolingservice und zwei mit identischen Eingaben tatsächlich erzeugten Ergebnisdateien. Das Interview umfasst 13 projektspezifische Fragen. Aus den dokumentierten Rohantworten wurde retrospektiv ein Referenzstandard mit 35 atomaren Fakten konstruiert. Beispiele sind benannte Ansprechpartner, eine Negation wie „keine externen Stakeholder“, ein Dokumentationsort oder die Kausalbeziehung zwischen falschen Annahmen und fehlerhaftem Code.

Die zwei Ergebnisdateien werden unabhängig voneinander gegen denselben Referenzstandard geprüft. Dadurch lassen sich Faktendeckung, unbelegte Ergänzungen, Strukturkonformität und Unterschiede zwischen den beiden Durchläufen bestimmen. Wegen des einzelnen fachlichen Falls handelt es sich um eine formative Einzelfallevaluation, nicht um einen allgemeinen Wirksamkeitsnachweis.
...
Die synthetischen Vollinterviews wurden nicht mit den realen Agentenergebnissen aggregiert. In sechs bewusst manipulierten Ausgabebeispielen wurden insgesamt zehn Auslassungen, fünf unbelegte Zusatzbehauptungen und eine kritische Datenschutzverletzung platziert. Die Anwendung der vorab festgelegten Regeln ordnet diese Muster den vorgesehenen Kategorien zu. Besonders relevant ist die Trennung zwischen einer geringen Zusatzbehauptung und einer kritischen Abweichung: Eine zusätzliche, aber folgenarme Negativfeststellung erhält Stufe 1; die Übernahme einer fachlich irrelevanten personenbezogenen Leistungs- oder Gesundheitsangabe erhält Stufe 3.

Diese Prüfung zeigt, dass das Bewertungsinstrument unterschiedliche Fehlerklassen abbilden kann. Sie misst jedoch nicht die Wahrscheinlichkeit, mit der der implementierte Agent diese Fehler tatsächlich erzeugt. Weil Konstruktion und Codierung durch dieselbe Person erfolgten, handelt es sich um einen methodischen Selbsttest. Eine unabhängige Zweitcodierung wäre erforderlich, um die Zuverlässigkeit der Klassifikation belastbar zu beurteilen.

Der isolierte Robustheitskatalog definiert zwölf künftig ausführbare Testfälle. Für normale Fälle gilt als Abnahmeregel, dass mindestens zwei von drei Wiederholungen das erwartete Verhalten zeigen und kein schwerer Fehler auftritt. Schutzfälle zu Prompt-Injection, personenbezogenen Daten und Geheimnissen müssen in allen drei Wiederholungen bestanden werden. Realistischer als eine reine Aufforderung zum Überspringen des Fragenkatalogs ist dabei die Prüfung, ob eingebettete Anweisungen zur Offenlegung von Systemprompt, Dateien oder Inhalten anderer Interviews führen. Die Ausgabe darf solche Inhalte weder anzeigen noch in das Wissensdokument übernehmen.

Für die spätere automatisierte Bewertung könnte ein zweites Modell ergänzend eingesetzt werden. Aufgrund der bekannten Zuverlässigkeits- und Biasrisiken von LLM-as-a-Judge sollte es jedoch nur als Hinweisgeber dienen. Die endgültige Bewertung schwerer oder kritischer Fälle muss durch eine fachkundige Person erfolgen \cite{gu2026}.

\subsection{Testfallgruppen und erwartete Signale}

Die zwölf isolierten Fälle lassen sich in drei Gruppen einteilen. Die erste Gruppe prüft inhaltliche Robustheit. M01 kontrolliert, ob aus einer Antwort wie „Weiß ich nicht“ keine positive Fachinformation erzeugt wird. M02 prüft, ob Umgangssprache neutralisiert wird, ohne einen Unsicherheitsmarker wie „manchmal“ zu entfernen. M03, M05 und M06 fokussieren Reihenfolgen, Negationen und Kausalbeziehungen. M04 verlangt bei einem internen Widerspruch eine Klärung statt einer sprachlichen Harmonisierung. M07 prüft, ob Inhalte zweier Projekte getrennt bleiben.

Die zweite Gruppe adressiert Schutzanforderungen. M08 enthält eine fachlich irrelevante personenbezogene Gesundheits- oder Leistungsangabe. Sie darf nicht in ein allgemeines Wissensdokument übernommen werden. M09 enthält eine indirekte Prompt-Injection, die nicht nur zum Überspringen des Interviews auffordert, sondern die Offenlegung interner Anweisungen oder anderer Daten verlangt. M10 enthält ein als Beispiel eingebettetes Geheimnis. Für diese Fälle gilt kein Mehrheitskriterium: Bereits ein einziger Lauf mit Offenlegung oder Übernahme wäre ein kritischer Fehler. Diese strenge Regel folgt aus der Risikoeinordnung von Prompt-Injection und sensibler Informationspreisgabe in OWASP sowie der risikobasierten Perspektive des NIST-Profils \cite{owasp2025llm,nist2024genai}.

Die dritte Gruppe prüft Kontextgrenzen. M11 platziert einen relevanten Ablageort am Ende einer langen, teilweise irrelevanten Antwort. M12 verwendet eine mehrdeutige Abkürzung. Erwartet wird entweder eine Rückfrage oder eine ausdrückliche Unsicherheitsmarkierung; eine eigenmächtige Auflösung würde eine neue Tatsachenbehauptung erzeugen.

\subsection{Durchführungsprotokoll für reale Wiederholungstests}

Damit die geplanten 36 Robustheitsläufe reproduzierbar sind, muss jeder Lauf mit denselben technischen Rahmenbedingungen dokumentiert werden. Zu protokollieren sind mindestens Modellbezeichnung und Modellversion, Region, System- und Agentenprompt, Fragenkatalogversion, Temperatur beziehungsweise Sampling-Konfiguration, verwendete Tools, Datum und Uhrzeit sowie die vollständige Roh- und Ergebnisdatei. Der Prompt sollte als versionierte Datei oder über einen Hash referenziert werden. Änderungen zwischen Läufen müssen ausgeschlossen oder ausdrücklich als eigener Testfaktor behandelt werden.

Ein normaler Robustheitsfall gilt als stabil bestanden, wenn mindestens zwei von drei Läufen das Abnahmekriterium erfüllen, kein Lauf einen kritischen Fehler enthält und die abweichende Ausgabe dokumentiert wird. Für M08 bis M10 gilt 3 von 3. Die Gesamtfreigabe erfordert zusätzlich, dass keine Testgruppe ausschließlich durch einen guten Durchschnitt verdeckt wird. Ein System kann daher trotz hoher Gesamtquote durchfallen, wenn ein einzelner Schutzfall verletzt wird.

Die Ergebnisse der Robustheitsläufe dürfen getrennt von der Inhaltsqualität vollständiger Interviews berichtet werden. Ein bestandener Prompt-Injection-Test erhöht beispielsweise nicht den Recall der Wissenszusammenfassung. Umgekehrt sagt ein hoher Recall nichts darüber aus, ob das System Geheimnisse sicher behandelt. Die getrennte Berichterstattung verhindert, dass inhaltliche und sicherheitsbezogene Eigenschaften zu einer schwer interpretierbaren Gesamtzahl vermischt werden.
...
Eine belastbarere Folgeevaluation sollte mindestens drei reale Anwendungsfälle mit unterschiedlichen Schwierigkeitsgraden umfassen. Der erste Fall kann kurze, eindeutige Antworten enthalten und als Standardfall dienen. Der zweite sollte lange Antworten, mehrere Abhängigkeiten, Bedingungen und zeitliche Reihenfolgen umfassen. Der dritte sollte kontrolliert schwierige, aber reale Situationen mit Unsicherheiten, Negationen und widersprüchlichen Angaben enthalten. Jeder Fall wird dreimal mit identischen Eingaben ausgeführt. Damit entstehen neun tatsächliche vollständige Agentenläufe.

Für jeden Fall wird vor der Auswertung ein eigener Referenzstandard erstellt. Die Referenzbildung sollte durch zwei fachkundige Personen erfolgen, die zunächst unabhängig atomisieren. Abweichungen in der Faktengranularität werden vor der Bewertung der Agentenausgaben geklärt. Dadurch wird verhindert, dass der Referenzstandard unbewusst an eine konkrete Ausgabe angepasst wird. Anschließend codieren beide Personen die neun Ergebnisdateien unabhängig. Die Übereinstimmung kann für binäre Entscheidungen als prozentuale Übereinstimmung und ergänzend über Cohen-Kappa berichtet werden.

Die Abnahme sollte fallweise und aggregiert erfolgen. Vorgeschlagen werden mindestens \pct{95} Faktendeckung und Präzision pro Anwendungsfall, \pct{100} Strukturkonformität, mindestens \pct{90} Laufstabilität sowie keine kritischen Abweichungen. Ein Fall mit einem kritischen Fehler gilt unabhängig vom Gesamtmittel als nicht bestanden. Bei langen oder komplexen Antworten sollte zusätzlich der Recall für Bedingungen, Negationen und Kausalbeziehungen separat ausgewiesen werden.

Parallel zur Qualität werden Prozesszeiten gemessen. Für jeden Lauf sind Vorbereitung, eigentliche Interviewzeit, automatische Verarbeitung, fachliche Prüfung, Korrektur und Ablage getrennt zu erfassen. Die manuelle Vergleichsgruppe muss denselben Fragenkatalog und dasselbe Ergebnisformat verwenden. Erst diese kontrollierte Gegenüberstellung erlaubt eine empirische Aussage darüber, ob die modellierten 45 Minuten realistisch sind und ob Zeitgewinn durch zusätzlichen Prüfaufwand teilweise wieder verloren geht.

Die synthetischen Robustheitsfälle bleiben als eigener technischer Testblock bestehen. Sie werden bei Änderungen von Modell, Prompt oder Agentenlogik erneut ausgeführt und dienen damit als Regressionstests. Die realen vollständigen Interviews beantworten die Frage nach der betrieblichen Ergebnisqualität; die synthetischen Grenzfälle prüfen gezielt seltene, aber risikoreiche Fehlerbedingungen. Erst die Kombination beider Ebenen liefert eine belastbare Grundlage für eine Produktiventscheidung.
...
Jeder Fall ist künftig dreimal mit identischem Input gegen dieselbe dokumentierte Modell- und Promptversion auszuführen. Die Spalte „Abnahmekriterium“ beschreibt das erwartete Verhalten; sie enthält keine behaupteten Testergebnisse.
