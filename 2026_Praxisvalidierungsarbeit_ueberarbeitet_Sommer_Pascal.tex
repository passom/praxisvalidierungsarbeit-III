...
\begin{center}
    ...
    {\LARGE \textbf{{Vergleichende Evaluation von Ergebnisqualität und Bearbeitungsaufwand}}}\\
...
Wissen über informelle Abläufe, persönliche Netzwerke, bewährte Vorgehensweisen und typische Fehlerquellen ist für die Kontinuität betrieblicher Prozesse von hoher Bedeutung. Ein erheblicher Teil dieses Wissens liegt jedoch nicht in formalen Dokumentationen vor, sondern ist an einzelne Beschäftigte und deren Erfahrungen gebunden. Aktuelle Forschung zum KI-gestützten Wissensmanagement verweist darauf, dass insbesondere das Ausscheiden erfahrener Beschäftigter das Risiko eines Verlusts von Erfahrungswissen erhöht \cite[S.~1--7]{nicole_ottersbock_wissensmanagement_2026}. Zugleich zeigen betriebliche Forschungsprojekte, dass digitale Lösungsansätze Wissen effizienter generieren, strukturieren und für weitere Personen bereitstellen können, sofern technische und arbeitsorganisatorische Anforderungen gemeinsam betrachtet werden \cite[S.~429--432]{schweiger_serwiss_2023}. Im untersuchten Unternehmenskontext wurde deshalb ein KI-gestützter Agent entwickelt, der strukturierte Interviews durchführt, Antworten zusammenfasst, vorgegebenen Kategorien zuordnet und als bearbeitbare Dokumente bereitstellt \cite{sommer2026projekt}.
...
Die vorliegende Arbeit erweitert die Projektdokumentation daher um eine vergleichende Evaluation. 
Im Mittelpunkt stehen nicht die technische Implementierung des Agenten oder eine erneute Darstellung der Architektur,
sondern die Frage, ob die erzeugten Wissensdokumente für den betrieblichen Zweck hinreichend zuverlässig sind und 
wie der erwartete Bearbeitungsaufwand im Verhältnis zur manuellen Vorgehensweise einzuordnen ist.
...
Die Arbeit ist als eingebettete Einzelfallstudie angelegt. Die quantitative Aussagekraft ist dadurch begrenzt.
Zugleich ermöglicht der Ansatz eine nachvollziehbare Prüfung des konkret entwickelten Artefakts im betrieblichen Kontext.
...
Erfahrungswissen ist häufig an konkrete Personen, Arbeitsabläufe und betriebliche Kontexte gebunden. Im Forschungsprojekt IDboard wird das Triadengespräch als narratives Verfahren zum Transfer personengebundenen, erfahrungsbasierten Wissens beschrieben. Eine erfahrene Person schildert relevante Lern- und Erfahrungssituationen einschließlich ihres Entstehungskontexts. Eine wissensnehmende Person stellt Nach- und Verständnisfragen, während eine moderierende Person vermeintlich selbstverständliche Aspekte hinterfragt und detaillierte Erläuterungen anregt \cite[S.~132--135]{sander_onboarding_2023}. Für die betriebliche Wissenssicherung ist daran besonders relevant, dass nicht nur isolierte Sachinformationen, sondern auch Erfahrungen, Begründungen und situative Vorgehensweisen erhoben werden.

Für Organisationen besteht daher die Herausforderung, relevante Bestandteile dieses personengebundenen Wissens so zu explizieren, dass sie für andere Beschäftigte zugänglich und wiederverwendbar werden. Das Triadengespräch zeigt exemplarisch, dass Erzählungen, Nachfragen und die anschließende Ergebnissicherung die Explikation impliziten Wissens anregen können. Als mögliche Formen der Weiterverwendung werden unter anderem Transkriptionen, Lessons Learned und textliche Zusammenfassungen genannt \cite[S.~134--136]{sander_onboarding_2023}. Ein Interview kann diesen Prozess unterstützen, indem gezielte Fragen die befragte Person dazu veranlassen, Handlungen, Abhängigkeiten, Erfahrungen und Bewertungen zu reflektieren. Das Interview erzeugt jedoch nicht automatisch ein nutzbares Wissensprodukt. Die Antworten müssen ausgewählt, verdichtet und in einer Struktur abgelegt werden, die für spätere Nutzer:innen verständlich bleibt.

Der entwickelte Agent übernimmt genau diese nachgelagerte Transformationsleistung. Er führt durch einen vorgegebenen Fragenkatalog, speichert Rohantworten und erzeugt zu jeder Antwort eine Kurzfassung. Die Kurzfassungen werden den Kategorien „Erfahrungen und Empfehlungen“, „Prozesse und Arbeitsschritte“ sowie „Sonstiges“ zugeordnet. Damit greift das Artefakt einen in aktuellen Digitalisierungsprojekten beschriebenen Anwendungsfall auf: Wissen soll mit vertretbarem Aufwand generiert, strukturiert, dauerhaft verfügbar gemacht und in späteren Arbeitssituationen wiederverwendet werden \cite[S.~429--432, 438--440]{schweiger_serwiss_2023}. Der fachliche Nutzen hängt folglich nicht nur von der Dialogführung, sondern wesentlich von der Qualität der Zusammenfassung ab.
...
Die Ergebnisse stützen die Annahme, dass ein regelgebundener KI-Agent besonders bei standardisierbaren Nachbereitungsschritten einen Nutzen bietet. Das Interview selbst bleibt ein sozialer und inhaltlicher Prozess. Die interviewte Person muss bereit und in der Lage sein, relevante Erfahrungen zu artikulieren. Der Agent kann nicht erkennen, welches Wissen nicht genannt wurde, wenn keine Rückfrage- oder Validierungslogik greift. Im Projekt war eine systematische Prüfung zu knapper oder unklarer Antworten noch nicht vollständig umgesetzt. Die gemessene Vollständigkeit bezieht sich daher auf die Übertragung vorhandener Antworten, nicht auf die vollständige Erhebung des tatsächlich vorhandenen impliziten Wissens. Dies entspricht der Einordnung digital unterstützter Onboarding- und Transferprozesse, nach der digitale Werkzeuge menschliche und soziale Interaktionen unterstützen, aber nicht vollständig ersetzen sollen \cite[S.~143--145]{sander_onboarding_2023}.
...
Weiterhin sollte die Anwendung eine verpflichtende Human-in-the-Loop-Freigabe vorsehen. Ein produktiver Einsatz ist nicht allein als technische Einführung zu behandeln. Der BMBF-Sammelband zur Digitalisierung der Arbeitswelt beschreibt digitale Arbeitssysteme ausdrücklich als Zusammenspiel von Mensch, Technik und Organisation und hebt die frühzeitige Beteiligung der Beschäftigten bei Gestaltung und Einführung hervor \cite[S.~4--6, 10--11]{boehme_nedz_2023}. Für digitale Onboarding-Instrumente wird ergänzend eine Balance zwischen technischer Unterstützung und zwischenmenschlicher Interaktion gefordert \cite[S.~143--145]{sander_onboarding_2023}. Auch aktuelle Forschung zu KI-basiertem Wissensmanagement empfiehlt eine transparente, partizipative und kontinuierlich evaluierte Einführung \cite[S.~77--110]{nicole_ottersbock_wissensmanagement_2026}. In der Ergebnisdatei sollten Kurzfassung und zugehörige Rohantwort eindeutig miteinander verknüpft sein. Markierungen für unsichere, sehr kurze oder widersprüchliche Antworten würden die Prüfung erleichtern. Für sensible Inhalte sind ein Rollen- und Berechtigungskonzept, definierte Löschfristen, Protokollierung und eine klare Verantwortlichkeit für die spätere Pflege der Dokumente erforderlich. Ohne diese organisatorischen Maßnahmen würde der Agent zwar Dokumente erzeugen, aber das grundlegende Problem veralteter oder unklar verantworteter Wissensbestände nicht vollständig lösen.
